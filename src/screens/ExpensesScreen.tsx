    ...
    return (
        <div>
            <div className="mb-5 flex items-center justify-between">
                ...
                {!showAddForm && (
                    <button onClick={() => setShowAddForm(true)} className="fab-green w-11 h-11" title="Add Expense">
            ...
            {!showAddForm && (
                <motion.div
                    ...
                    className="relative rounded-[24px] p-6 mb-5 overflow-hidden shadow-[0_8px_32px_rgba(28,232,183,0.25)] border border-white/20"
                ...
                >
                    ...
                    <div className="mt-4 pt-4 border-t border-[#030609]/15 flex justify-between text-sm">
                ...
                <div className="space-y-3">
                    {currentEvent.expenses.length === 0 ? (
                        <div className="panku-card py-16 text-center border-dashed border-2 border-white/10 bg-transparent shadow-none hover:border-white/20">
                            ...
                            <p className="text-[#94A3B8] text-sm mb-6 max-w-[200px] mx-auto">Tap <strong className="text-[#1CE8B7]">+</strong> to add your first expense.</p>
                            <button onClick={() => setShowAddForm(true)} className="btn-green px-6 py-3 font-semibold inline-flex items-center gap-2">
                        ...
                        <AnimatePresence>
                            {currentEvent.expenses.map((expense, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Icon */}
                                        <div className="w-12 h-12 rounded-[14px] panku-card-inner flex items-center justify-center shrink-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group-hover:scale-110 transition-transform text-[#1CE8B7]">
                                        ...
                                        <div className="flex flex-col items-end gap-1.5 shrink-0">
                                            ...
                                            <button
                                                ...
                                                className="text-[#64748B] hover:text-[#FF4757] p-1.5 rounded-lg hover:bg-[#FF4757]/10 transition-all opacity-0 group-hover:opacity-100"
                                            >
                                                <Trash2 size={16} />
                                            </button>
                                        </div>
